CREATE TABLE articulos (
  ...
  --consulta de un aumento de precio de 10% con el alias nuevo precio, operadores + y *
  select nombre, descripcion, precio + (precio*0.1) as "Nuevo Precio" from articulos;

  -- consulta de de lo que tengo disponible para vender con el alias existencia, operador - de dos campos de cada registro
  select codigo, nombre, cantidad - vendidos as existencia from articulos;
