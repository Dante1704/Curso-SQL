...
-- consulta de todos los datos en base a un critero, where

-- en este caso en base a Jorge, y me va a traer toda la fila de sus datos
select * from empleados where nombre = 'Jorge';

select * from empleados where edad = 29;

-- consulta de algunos datos excluyendo otros en base a un critero, where
select nombre, apellido, edad from empleados where nombre = 'Dante';
