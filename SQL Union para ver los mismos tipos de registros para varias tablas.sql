...
/*
Reglas
1- se deben consultar las mismas columnas
2- las columnas deben tener los mismos tipos de datos
*/

-- podemos ver los mismos datos de ambas tablas juntos a la vez

--en esta consulta no puedo saber a que tabla corresponde cada registro mostrado
select direccion, contacto, ciudad, pais from clientes
union -- por defecto no me trae los valores duplicados
select direccion, contacto, ciudad, pais from suplidores;


--en esta consulta si puedo saber a que tabla corresponde cada registro mostrado
select 'Cliente' as Tabla, direccion as Domicilio, contacto, ciudad, pais from clientes where pais ='Argentina'
union all --all me permite ver los datos duplicados tambien
select 'Suplidor' as Tabla, direccion, contacto, ciudad, pais from suplidores where pais = 'Argentina'
order by contacto;