...
--consulta con operador and para pedir para busquedas mas precisas, solo de a pares. 

select * from clientes
where pais = 'Italia' and ciudad = 'Roma';

--esto es como poner mas de un and
select * from clientes
where pais = 'Italia' and ciudad in('Roma', 'Venecia');

--consulta con operador or 
--para pedir los que cumplan con una condicion mas los que cumplan con la otra
--sin necesidad de que cumplan los dos a la vez
...
--no van a venir clientes de alemania
select * from clientes
where not pais = 'Alemania';

--no van a venir clientes de alemania ni de italia
select * from clientes
